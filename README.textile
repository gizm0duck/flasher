...
This will work out of the box with all the pretty colors if you are using Blueprint css or something similar, otherwise it will take some tweaking to show up perfect.
