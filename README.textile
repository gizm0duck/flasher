...
Flasher is a quick way to get pretty flash message for :error, :notice, and :success keys out of the box for Rails apps.  Setup is fairly simple, but may take some tweeking
if you are not using blueprint.css or something similar.  If you aren't I recommend checking it out http://wiki.github.com/joshuaclayton/blueprint-css
...
Icons are from the awesome fat cow free icon set: 
